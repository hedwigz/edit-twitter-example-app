...
func Created(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func CreatedEQ(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreated), v))
	})
}
...
func CreatedNEQ(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func CreatedIn(vs ...time.Time) predicate.Tweet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedNotIn(vs ...time.Time) predicate.Tweet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedGT(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func CreatedGTE(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func CreatedLT(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func CreatedLTE(v time.Time) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func HasLikesWith(preds ...predicate.User) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
