...
func (c *Changes) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     c.ID,
		Type:   "Changes",
		Fields: make([]*Field, 3),
	...
	var buf []byte
	if buf, err = json.Marshal(c.Column); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(c.Previous); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	err = c.QueryOperation().
		Select(history.FieldID).
...
func (h *History) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     h.ID,
		Type:   "History",
		Fields: make([]*Field, 4),
	...
	var buf []byte
	if buf, err = json.Marshal(h.EntityName); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(h.RecordID); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(h.Timestamp); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(h.Action); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "history.Action",
...
func (t *Tweet) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(t.Content); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(t.Created); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "time.Time",
...
func (u *User) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(u.Created); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "time.Time",
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	switch table {
	case changes.Table:
		n, err := c.Changes.Query().
			Where(changes.ID(id)).
			CollectFields(ctx, "Changes").
			Only(ctx)
		if err != nil {
			return nil, err
		}
		return n, nil
	case history.Table:
		n, err := c.History.Query().
			Where(history.ID(id)).
			CollectFields(ctx, "History").
			Only(ctx)
		if err != nil {
			return nil, err
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	switch table {
	case changes.Table:
		nodes, err := c.Changes.Query().
			Where(changes.IDIn(ids...)).
			CollectFields(ctx, "Changes").
			All(ctx)
		if err != nil {
			return nil, err
	...
	case history.Table:
		nodes, err := c.History.Query().
			Where(history.IDIn(ids...)).
			CollectFields(ctx, "History").
			All(ctx)
		if err != nil {
			return nil, err
